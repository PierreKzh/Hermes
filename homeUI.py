...
class Ui_home(object):
    def setupUi(self, homeWindow, password):
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_IPaddress)
        self.lineEdit_IPaddress = QtWidgets.QLineEdit(self.page_AddContact)
        self.lineEdit_IPaddress.setObjectName("lineEdit_IPaddress")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.lineEdit_IPaddress)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.SpanningRole, self.pushButton_Add)
